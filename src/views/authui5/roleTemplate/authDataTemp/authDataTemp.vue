 ...
 * @LastEditTime: 2020-06-03 11:47:14
...
<z-modal v-model="modelIsOpen" title="数据授权" fixed height="500" width="600">
    ...
    <div v-if="!multiApp || showAuthData" :class="{'multi-apply-tree':multiApp}">
        ...
        <z-vtree ref="authDataTree" :multiple="true" :option="options"  choose-mode="some" v-model="value"></z-vtree>
   </div>
...
export default {
  ...
  methods: {
    query: function () {
      ...
      roleTemplateApi.dataRoleTempTreeURL(param).then(function (response) {
    ...
    handleSubmit: function () {
      ...
      roleTemplateApi.saveRoleDataCateTempInfo(params).then(function (response) {
